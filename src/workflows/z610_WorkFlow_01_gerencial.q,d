{
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "</thead>\n",
       "<tbody>\n",
       "\t<tr><th scope=row>Ncells</th><td> 656928</td><td>35.1</td><td>1439345</td><td>76.9</td><td>1431331</td><td>76.5</td></tr>\n",
      ...
      "text/latex": [
       ...
       "\\hline\n",
       "\tNcells &  656928 & 35.1 & 1439345 & 76.9 & 1431331 & 76.5\\\\\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "\n",
      "Wed Aug 06 17:48:21 2025 AUC 0.928164947784762\n",
      "\n",
      "Wed Aug 06 17:48:41 2025 AUC 0.927703386865441\n",
      "\n",
      "Wed Aug 06 17:48:59 2025 AUC 0.92960987443782\n",
      "\n",
      "Wed Aug 06 17:49:20 2025 AUC 0.929159898882939\n",
      "\n",
      "Wed Aug 06 17:49:41 2025 AUC 0.925928972447686\n",
      "\n",
      "Wed Aug 06 17:50:26 2025 AUC 0.93333271544723\n",
      "\n",
      "Wed Aug 06 17:50:52 2025 AUC 0.93297055695481\n",
      "\n",
      "Wed Aug 06 17:51:09 2025 AUC 0.927776142954129\n",
      "\n",
      "[mbo] 0: num_leaves=108; min_data_in_leaf=4418 : y = 0.928 : 25.4 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=137; min_data_in_leaf=6804 : y = 0.928 : 19.8 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=171; min_data_in_leaf=2517 : y = 0.93 : 18.5 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=38; min_data_in_leaf=4052 : y = 0.929 : 21.0 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=244; min_data_in_leaf=7597 : y = 0.926 : 20.7 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=208; min_data_in_leaf=1454 : y = 0.933 : 44.4 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=22; min_data_in_leaf=892 : y = 0.933 : 26.6 secs : initdesign\n",
      "\n",
      "[mbo] 0: num_leaves=81; min_data_in_leaf=5810 : y = 0.928 : 17.0 secs : initdesign\n",
      "\n",
      ...
      "Wed Aug 06 17:52:12 2025 AUC 0.935018154266079\n",
      "\n",
      "[mbo] 1: num_leaves=256; min_data_in_leaf=905 : y = 0.935 : 62.4 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      ...
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 875 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 114 points instead of 1000!”\n",
      "Wed Aug 06 17:52:51 2025 AUC 0.938000458780432\n",
      "\n",
      "[mbo] 2: num_leaves=256; min_data_in_leaf=2 : y = 0.938 : 37.9 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 476 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 540 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 578 points instead of 1000!”\n",
      "Wed Aug 06 17:53:22 2025 AUC 0.935498483475795\n",
      "\n",
      "[mbo] 3: num_leaves=208; min_data_in_leaf=2 : y = 0.935 : 29.9 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 306 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 453 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 453 points instead of 1000!”\n",
      "Wed Aug 06 17:53:59 2025 AUC 0.938495153842054\n",
      "\n",
      "[mbo] 4: num_leaves=256; min_data_in_leaf=120 : y = 0.938 : 36.6 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 651 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 645 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 615 points instead of 1000!”\n",
      "Wed Aug 06 17:55:03 2025 AUC 0.937750678323088\n",
      "\n",
      "[mbo] 5: num_leaves=256; min_data_in_leaf=252 : y = 0.938 : 62.8 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      ...
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 903 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 117 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 866 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 111 points instead of 1000!”\n",
      "Wed Aug 06 17:55:58 2025 AUC 0.916029973654881\n",
      "\n",
      "[mbo] 6: num_leaves=2; min_data_in_leaf=2 : y = 0.916 : 54.4 secs : infill_ei\n",
      "\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 526 points instead of 1000!”\n",
      "Warning message in generateDesign(control$infill.opt.focussearch.points, ps.local, :\n",
      "“generateDesign could only produce 864 points instead of 1000!”\n",
      "Wed Aug 06 17:56:34 2025 AUC 0.934288044599019\n",
      "\n",
      "[mbo] 7: num_leaves=208; min_data_in_leaf=628 : y = 0.934 : 35.4 secs : infill_ei\n",
      "\n",
      "Wed Aug 06 17:56:51 2025 AUC 0.930592776756978\n",
      "\n",
      "[mbo] 8: num_leaves=55; min_data_in_leaf=1520 : y = 0.931 : 16.3 secs : infill_ei\n",
      "\n",
      "Wed Aug 06 17:57:24 2025 AUC 0.931184557172615\n",
      "\n",
      "[mbo] 9: num_leaves=256; min_data_in_leaf=2257 : y = 0.931 : 32.3 secs : infill_ei\n",
      "\n",
      "Wed Aug 06 17:57:55 2025 AUC 0.933784312953133\n",
      "\n",
      "[mbo] 10: num_leaves=130; min_data_in_leaf=1010 : y = 0.934 : 29.9 secs : infill_ei\n",
      "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ec5c2763-4dbc-40a5-b703-9b999d14e634",
   "metadata": {},
   "outputs": [],
   "source": []
  }
